...
func TestSaverFood_Success(t *testing.T) {
	...
	image := "./../../internal/unit_test/test_images/amala.jpg" //this is where the image is located
...
func TestUpdateFood_Success_With_File(t *testing.T) {
	...
	image := "./../../internal/unit_test/test_images/new_meal.jpeg" //this is where the image is located
	file, err := os.Open(image)
	if err != nil {
		t.Errorf("Cannot open file: %s\n", err)
	}
