...
type TransactionInterface interface {
	SaveFood(c *gin.Context)
	UpdateFood(c *gin.Context)
	GetAllFood(c *gin.Context)
	GetFoodAndCreator(c *gin.Context)
...
// Food constructor
func NewTransaction(fApp application.FoodAppInterface, uApp application.UserAppInterface, fd fileupload.UploadFileInterface, rd auth.AuthInterface, tk auth.TokenInterface) *Food {
	return &Food{
		foodApp:    fApp,
		userApp:    uApp,
		fileUpload: fd,
...
func (fo *Food) InsterTransaction(c *gin.Context) {
...
func (fo *Food) UpdateTransaction(c *gin.Context) {
...
func (fo *Food) GetTransactionList(c *gin.Context) {
...
func (fo *Food) GetTransaction(c *gin.Context) {
	foodId, err := strconv.ParseUint(c.Param("food_id"), 10, 64)
	if err != nil {
		c.JSON(http.StatusBadRequest, "invalid request")
		return
